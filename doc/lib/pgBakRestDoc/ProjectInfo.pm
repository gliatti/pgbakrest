...
####################################################################################################################################
package pgBakRestDoc::ProjectInfo;
...
####################################################################################################################################
require pgBakRestTest::Common::Storage;
require pgBakRestTest::Common::StoragePosix;

my $strProjectInfo = ${new pgBakRestTest::Common::Storage(
    dirname(dirname(abs_path($0))), new pgBakRestTest::Common::StoragePosix())->get('src/version.h')};
