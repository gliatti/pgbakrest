...
####################################################################################################################################
package pgBakRestDoc::Html::DocHtmlElement;
...
sub addNew
{
    ...
    my $oElement = new pgBakRestDoc::Html::DocHtmlElement($strType, $strClass, $oParam);
...
sub add
{
    ...
    if (!(blessed($oElement) && $oElement->isa('pgBakRestDoc::Html::DocHtmlElement')))
    {
