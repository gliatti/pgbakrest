...
testRun(void)
{
    ...
    if (testBegin("restoreRecoveryOption() and restoreRecoveryConf()"))
    {
        ...
        #define RECOVERY_SETTING_HEADER                             "# Recovery settings generated by pgBakRest restore on LABEL\n"
    ...
    if (testBegin("restoreRecoveryWrite*()"))
    {
        ...
        const String *restoreLabel = STRDEF("LABEL");
        #define RECOVERY_SETTING_PREFIX                             "# Removed by pgBakRest restore on LABEL # "
    ...
    if (testBegin("cmdRestore()"))
    {
        ...
        TEST_RESULT_LOG_FMT(
            ...
            "P01 DETAIL: restore file " TEST_PATH "/pg/global/pg_control.pgbakrest.tmp (8KB, [PCT])"
            " checksum %s\n"
