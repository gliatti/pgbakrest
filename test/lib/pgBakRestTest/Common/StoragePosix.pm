...
####################################################################################################################################
package pgBakRestTest::Common::StoragePosix;
...
use pgBakRestTest::Common::StorageBase;
use pgBakRestTest::Common::StoragePosixRead;
use pgBakRestTest::Common::StoragePosixWrite;
...
sub openRead
{
    ...
    my $oFileIO = new pgBakRestTest::Common::StoragePosixRead($self, $strFile, {bIgnoreMissing => $bIgnoreMissing});
...
sub openWrite
{
    ...
    my $oFileIO = new pgBakRestTest::Common::StoragePosixWrite(
        $self, $strFile,
